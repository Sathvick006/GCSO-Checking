...
function setup() {
   ...
   car1 = createSprite(200,100,25,25);
   car1.weight = 2260;
   car1.speed = car1.velocityX = 60;

   car2 = createSprite(200,250,25,25);
   car2.weight = 1522;
   car2.speed = car2.velocityX = 50;

   car3 = createSprite(200,400,25,25);
   car3.weight = 3000;
  ...
  function draw() {
    ...
    if(wall.x - car1.x < car1.width/2 + wall.width/2 && deformation1 > 180){
    car1.shapeColor = "red";
